        ...
        kmc: {
            ...
            main: {
                files: [
                    ...
                    {
                        src: "<%= pkg.version %>/alert.js",
                        dest: "<%= pkg.version %>/build/alert.js"
                    },
                    {
                        src: "<%= pkg.version %>/confirm.js",
                        dest: "<%= pkg.version %>/build/confirm.js"
                    },
                    {
                        src: "<%= pkg.version %>/prompt.js",
                        dest: "<%= pkg.version %>/build/prompt.js"
                    }
                ]
            }
        },
        ...
        uglify: {
            ...
            base: {
                files: {
                    ...
                    '<%= pkg.version %>/build/alert-min.js': ['<%= pkg.version %>/build/alert.js'],
                    '<%= pkg.version %>/build/confirm-min.js': ['<%= pkg.version %>/build/confirm.js'],
                    '<%= pkg.version %>/build/prompt-min.js': ['<%= pkg.version %>/build/prompt.js'],
                }
            }
        },
        copy: {
