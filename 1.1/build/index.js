...
gallery/easydialog/1.1/common
gallery/easydialog/1.1/alert
gallery/easydialog/1.1/confirm
gallery/easydialog/1.1/prompt
gallery/easydialog/1.1/index
 ...
 * @module easydialog
 **/
KISSY.add('gallery/easydialog/1.1/common',function(S,Node,Overlay,DD){
	var re = {};
	var $ = Node.all;
 ...
 * @module easydialog
 **/
KISSY.add('gallery/easydialog/1.1/alert',function(S,Base,Node,Common){
	var $ = Node.all;
 ...
 * @module easydialog
 **/
KISSY.add('gallery/easydialog/1.1/confirm',function(S,Base,Node,Common){
	var $ = Node.all;
 ...
 * @module easydialog
 **/
KISSY.add('gallery/easydialog/1.1/prompt',function(S,Base,Node,Common){
	var $ = Node.all;
 ...
 * @module easydialog
 **/
KISSY.add('gallery/easydialog/1.1/index',function(S,Alert,Confirm,Prompt){
    return {
        alert:Alert,
        confirm:Confirm,
        prompt:Prompt
